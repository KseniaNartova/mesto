...
const deleteCard = (idCard, card) => {
  ...
  popupWithDeleteCard.setSubmitHandler(() => {
    api
      .deleteСard(idCard)
      .then(() => {
...
const formValidationCard = new FormValidator(
  validationConfig,
  popupAddCardForm
);
...
const formValidationAvatar = new FormValidator(
  validationConfig,
  popupAvatarForm
);
